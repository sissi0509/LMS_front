...
export default function StudentQuizTake({
  ...
  const get_t = (a: Date) => {
    const date = a.toLocaleDateString("en-US", {
      timeZone: "UTC",
      month: "short",
      day: "2-digit",
    });
  ...
  return (
    <div>
      ...
      <div className="d-flex flex-wrap">
        <div className="me-5 text-nowrap mb-1">
          <b>Due </b>
          {get_t(new Date(quiz.dueDate))}
        </div>
        <div className="me-5 text-nowrap mb-1">
          <b>Points </b>
          {quizPoint}
        ...
        <div className="me-5 text-nowrap mb-1">
          <b>Available </b>
          {get_t(new Date(quiz.availableFrom))} -{" "}
          {get_t(new Date(quiz.availableUntil))}
        </div>

        {quiz.timeLimitMinutes > 0 ? (
          <div className="me-5 text-nowrap mb-1">
            <b>Time Limit</b> {quiz.timeLimitMinutes} Minutes
          </div>
        ) : (
          ""
        )}
